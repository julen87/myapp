package es.julen.myapp.web.rest;

import com.codahale.metrics.annotation.Timed;
import es.julen.myapp.domain.Authority;
import es.julen.myapp.domain.PersistentToken;
import es.julen.myapp.domain.User;
import es.julen.myapp.repository.PersistentTokenRepository;
import es.julen.myapp.repository.UserRepository;
import es.julen.myapp.security.SecurityUtils;
import es.julen.myapp.service.MailService;
import es.julen.myapp.service.UserService;
import es.julen.myapp.web.rest.dto.KeyAndPasswordDTO;
import es.julen.myapp.web.rest.dto.ManagedUserDTO;
import es.julen.myapp.web.rest.dto.UserDTO;
import es.julen.myapp.web.rest.util.HeaderUtil;
