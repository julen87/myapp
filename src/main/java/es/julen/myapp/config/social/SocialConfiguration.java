package es.julen.myapp.config.social;

import es.julen.myapp.repository.SocialUserConnectionRepository;
import es.julen.myapp.repository.CustomSocialUsersConnectionRepository;
import es.julen.myapp.security.social.CustomSignInAdapter;
