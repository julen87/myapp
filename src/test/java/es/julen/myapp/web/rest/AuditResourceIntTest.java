...
import es.julen.myapp.config.audit.AuditEventConverter;
import es.julen.myapp.domain.PersistentAuditEvent;
import es.julen.myapp.repository.PersistenceAuditEventRepository;
import es.julen.myapp.service.AuditEventService;
